...
public class SeconnecterController {
    ...
    void connexion(ActionEvent event) {
        ...
        Utilisateur loggedInUser = utilisateurService.login(textemail, textmdp);
        ...
        if (loggedInUser != null) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FrontMenu.fxml"));
            Parent root = null;
            try {
                root = loader.load();
            } catch (IOException e) {
         ...
         //   profileController homeInterfaceController = loader.getController();
           // homeInterfaceController.setUserData(loggedInUser);
            FrontMenuController fm =loader.getController();
            fm.setUserData(loggedInUser);
